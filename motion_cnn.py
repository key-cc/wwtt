...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=101, channel=2):
        self.inplanes = 64
...
def resnet152(pretrained=False, channel= 2,**kwargs):
...
if __name__ == '__main__':
    model = resnet152(pretrained= True, channel=2)
    # print (model)
    jim_input = torch.randn(1,2,224,224)
    out = model(jim_input)
    print(out.shape)