...
from motion_models import ConvLSTM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="F:\\tmp\\UCF3", help="Path to UCF-101 dataset")
    ...
    parser.add_argument("--sequence_length", type=int, default=10, help="Number of frames in each sequence")
